    ...
    <div className='div-container'>
      ...
      <div className="tratamiento-container">
        <div className="tratamiento-image-container">
          <img src="../public/Img/Terapia_individua.png" alt="Terapia Individual" className="tratamiento-image" />
        </div>
      ...
      <div className="tratamiento-container">
        <div className="tratamiento-image-container">
          <img src="../public/Img/Terapia_pareja.png" alt="Terapia en Pareja" className="tratamiento-image" />
        </div>
        <div className="tratamiento-info">
      ...
      <div className="tratamiento-container">
        <div className="tratamiento-image-container">
          <img src="../public/Img/Terapia_familia.png" alt="Terapia Familiar" className="tratamiento-image" />
        </div>
        <div className="tratamiento-info">
          <h3>Terapia Familiar</h3>
          <p>
            La Terapia Familiar se centra en mejorar la dinámica y la comunicación entre los miembros de la familia. Buscamos resolver conflictos familiares, fortalecer los lazos y promover un ambiente de apoyo y comprensión en el hogar.
          </p>
          <p><strong>Costo por hora:</strong> $120</p>
        </div>
      </div>
    </section>
